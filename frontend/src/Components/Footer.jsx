        ...
        <div className="Footer">
            ...
            <div className="Bottom-Footer">
                <div className="Bottom-Footer-Text">
                    <p> Meet our staff:</p>
                    <Link to="/editorial-board" className="Footer-Staff-Link">Editorial Board</Link>
                    <Link to="/senior-staffers" className="Footer-Staff-Link">Senior Staffers</Link>
                    <Link to="/junior-staffers" className="Footer-Staff-Link">Junior Staffers</Link>
                </div>
