...
export const getMediaSegmentLabel = (type) => {
    ...
    const mapping = {
        ...
        "ELECTION_UPDATES": "Election Updates",
        "ADVISORY": "Advisory",
        "ALERT": "Alert",
        "JUST_IN": "Just In",
...
export const getCategoryFallbackImage = (type) => {
    ...
    const fallbacks = {
        ...
        "BREAKING_NEWS": `${R2_PREFIX}/JUST-IN.jpg`,
        "CLOSURE_REPORT": `${R2_PREFIX}/JUST-IN.jpg`,
        "OFFICIAL_STATEMENT": `${R2_PREFIX}/JUST-IN.jpg`,
        "ELECTION_UPDATES": `${R2_PREFIX}/JUST-IN.jpg`,
