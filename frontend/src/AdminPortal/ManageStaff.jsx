...
const ManageStaff = () => {
    ...
    const handleStaffAdded = (newMember) => {
        setStaff((prev) => {
            const next = [...prev, newMember]
            return next.sort((a, b) => {
                const orderA = a.staff_order && a.staff_order > 0 ? a.staff_order : 999
                const orderB = b.staff_order && b.staff_order > 0 ? b.staff_order : 999
    ...
    return (
        <div className = "Manage-Staff-Page">
            <div className = "Manage-Staff-Page-Header">
                <div className = "Manage-Staff-Header-Top">
                    <div>
                        <h1> Manage Staff </h1>
                        <p>
                    ...
                    <button
                        type = "button"
                        className = "Add-Staff-Primary-Btn"
